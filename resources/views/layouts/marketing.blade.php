        ...
        <div class="container topbar__inner">
            <a class="brand" href="{{ route('home') }}" aria-label="E-Library home">
                @if (app()->getLocale() === 'kh')
                    ...
                    <span class="brand__text">បណ្ណល័យ</span>
                @else
            ...
            <nav class="nav" id="site-nav" aria-label="Main">
                ...
                <a class="nav__link {{ request()->routeIs('browse') ? 'is-active' : '' }}"
                    href="{{ route('browse') }}">Browse</a>
                <a class="nav__link {{ request()->routeIs('categories') ? 'is-active' : '' }}"
                    href="{{ route('categories') }}">Categories</a>
                <a class="nav__link {{ request()->routeIs('about') ? 'is-active' : '' }}"
                ...
                <div class="nav__right">
                    ...
                    <div class="lang">
                        <button class="lang__btn" id="langBtn" aria-expanded="false" aria-haspopup="menu"
                        ...
                        <div class="lang__menu" id="langMenu" role="menu" aria-labelledby="langBtn">
                            <a role="menuitem" class="lang__item {{ $currentLocale === 'en' ? 'is-active' : '' }}"
                                href="{{ route('locale.switch', ['locale' => 'en']) }}">
                                <span class="lang__code">EN</span>
                                <span class="lang__name">English</span>
                            </a>

                            <a role="menuitem" class="lang__item {{ $currentLocale === 'kh' ? 'is-active' : '' }}"
    ...
    <footer class="footer">
        <div class="container footer__grid">
            <div>
                ...
                <p class="muted mt-2">Access thousands of books, audiobooks, and articles. Learn and grow anytime,
                    anywhere.</p>
            </div>
