        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('author.books.published') }}" class="btn btn-sm btn-outline-success">
                        <i class="fas fa-check-circle me-1"></i>Published
                    </a>
                    <a href="{{ route('author.books.drafts') }}" class="btn btn-sm btn-outline-warning">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if($book->cover_image)
                                    <img src="{{ asset('storage/' . $book->cover_image) }}" alt="{{ $book->title }}" style="width: 40px; height: 50px; object-fit: cover;">
                                @else
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('author.books.show', $book->id) }}" class="btn btn-outline-primary" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('author.books.edit', $book->id) }}" class="btn btn-outline-secondary" title="Edit">
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-4">
                                <p class="text-muted">No books found. <a href="{{ route('author.books.create') }}">Create your first book</a></p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
